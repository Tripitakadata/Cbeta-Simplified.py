...
file_dir="/home/z/tripitaka_data/003.全唐文"

#tripitakalist=["经文代号","经文名称","字符总数","汉字总数","汉字比率","标点总数","句号比率","问号比率","感叹号比率","冒号比率","引号比率","逗号比率","顿号比率","汉字标点数"]
tripitakalist=["经文代号","字符总数","汉字总数","汉字比率","标点总数","句号比率","问号比率","感叹号比率","冒号比率","引号比率","逗号比率","顿号比率","括号比率","汉字标点数"]

tripitakaTpye=[]
Total_punctuation=0
Total_character=0
workbook = xlsxwriter.Workbook('藏经-全唐文-标点统计.xls')
...
for root, dirs, files in os.walk(file_dir):
    ...
    for file_temp in sorted(files):
        ...
        if file_temp == "Readme.txt":
            ...
            worksheet.write(row, 12, (Juan.count('闕')*2)/max(1,Total_punctuation))
            worksheet.write(row, 13, Total_character/max(1,(Juan.count('。')+Juan.count('.')+Juan.count('？')+Juan.count('?')+Juan.count('！'))))
